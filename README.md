...
| ES version | Command |
| ---------- | ------- |
| 5.4.0 | `./bin/elasticsearch-plugin install https://oss.sonatype.org/service/local/repositories/infojohtani-1017/content/info/johtani/elasticsearch/plugin/ingest/ingest-csv/5.4.0.0/ingest-csv-5.4.0.0.zip` |
