...
| ES version | Command |
| ---------- | ------- |
| 5.3.0 | `./bin/elasticsearch-plugin install https://oss.sonatype.org/service/local/repositories/infojohtani-1018/content/info/johtani/elasticsearch/plugin/ingest/ingest-csv/5.3.0.0/ingest-csv-5.3.0.0.zip` |
